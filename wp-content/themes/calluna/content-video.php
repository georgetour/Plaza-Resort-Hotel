...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php $video_embed = esc_url( get_post_meta( $post->ID, '_calluna_video_embed', 1 ) ); ?>
	<?php if ($video_embed) { ?>
    ...
    <?php
			if ( is_single() ) :
				...
				if(! $video_embed && is_sticky() && is_home() && ! is_paged()) :
	...
	<?php else : ?>
	<div class="entry-content video_wrapper clearfix">
