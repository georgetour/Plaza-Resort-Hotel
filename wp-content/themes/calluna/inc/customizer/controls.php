 ...
 * Slider UI control
 */
class Calluna_Customize_Sliderui_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<div id="slider_<?php echo esc_attr($this->id); ?>" class="calluna-slider-ui"></div>
		<script>
			jQuery(document).ready(function($) {
				$( "#slider_<?php echo esc_js($this->id); ?>" ).slider({
					value : parseInt('<?php echo esc_js($this_val); ?>', 10),
 ...
 *
 */
class Calluna_Fonts_Dropdown_Custom_Control extends WP_Customize_Control {
	public function render_content() {
		$this_val = $this->value(); ?>
	<label>
		<span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
			<select <?php $this->link(); ?>>
			<option value="" <?php if( ! $this_val ) echo 'selected="selected"'; ?>><?php esc_html_e( 'Default', 'calluna-td' ); ?></option>
