	...
	public function apb_display_order_data( $order_id ) {
		...
		foreach ( $total_order_room as $item_book ) :
			...
			<ul class="order_details">
				...
				<li class="date">
					<?php esc_html_e( 'Booking duration:', 'awebooking' ); ?> <strong><?php echo date_i18n( get_option( 'date_format' ), strtotime( $item_book['from'] ) ) ?> - <?php echo date_i18n( get_option( 'date_format' ), strtotime( $item_book['to'] ) ) ?> </strong>
				</li>
				<li class="total">
