...
if ( ! function_exists( 'calluna_shortcodes_img_resize' ) ) {
	function calluna_shortcodes_img_resize( $url, $width, $height = null, $crop = null, $single = true ) {
	...
	// RETINA Support --------------------------------------------------------------->
	$supports_retina = apply_filters( 'calluna_shortcodes_image_retina', false );
